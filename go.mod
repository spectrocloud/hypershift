...
require (
	...
	github.com/openshift/cloud-credential-operator v0.0.0-20250814003803-57fbe1a2d19b
	github.com/openshift/cluster-api-provider-agent/api v0.0.0-20250302080306-e87c2e03fc96
